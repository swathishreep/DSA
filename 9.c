 ...
 visited[v] = true;
 printf("%d ", v);
 // Recur for al the vertices adjacent to this vertex
 ...
 97
 //FunctiontoperformDFSstartingfromagivenvertex
 voidDFS(Graph*graph, intstartVertex) {
 //Initializevisitedarray
 bool*visited=(bool*)malloc(graph->V*sizeof(bool));
 for(inti=0; i<graph->V; i++)
 visited[i]=false;
 //Call therecursivehelperfunctiontoperformDFS
 ...
 printGraph(graph);
 printf("\nDepthFirstTraversalstartingfromvertex0:\n");
 DFS(graph,0);
 return0;
